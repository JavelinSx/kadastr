...
"")
        ...
        self.comboBoxStatus.addItem("")
        self.comboBoxStatus.addItem("")
        self.gridLayout.addWidget(self.comboBoxStatus, 14, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.dateEditDataWork, 16, 2, 1, 1)
        ...
        addFormUi.setTabOrder(self.lineEditTelefone, self.dateEditDate)
        addFormUi.setTabOrder(self.dateEditDate, self.lineEditPrice)
